...
// component to control header state and actions during the purchase process
        ...
        <div className={"flex flex-row items-center justify-between p-5 border-b border-grey-300 mb-5"}>
            {
                !props.confirmation ? 
                    <React.Fragment>
                        <svg 
                            className="cursor-pointer text-gray-700 w-5 h-5" 
                            onClick={props.back} fill="currentColor" viewBox="0 0 20 20"
                        >
            ...
            <button onClick={() => {
                ...
                <svg className="float-right h-5 w-5 text-gray-700" fill="currentColor" viewBox="0 0 20 20">
