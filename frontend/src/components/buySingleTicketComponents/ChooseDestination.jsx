            ...
            <div className={this.props.chooseDestination ? "block" : "hidden"}>
                <div>
                    ...
                    <div className="pl-5 pr-5 pb-5">
                        ...
                        <input className="px-3 py-2 mb-2 w-full border rounded border-gray-400 text-sm text-gray-700" placeholder="Avreise" onChange={e => this.props.setStartPoint(e.target.value)}/>
                        <input className="px-3 py-2 w-full border rounded border-gray-400 text-sm text-gray-700" placeholder="Destinasjon" onChange={e => this.props.setEndPoint(e.target.value)} />
                    </div>
                </div>
                <div className="px-5">
                ...
                <div className="px-5">
                    ...
                    <div className="relative flex flex-row space-between mb-5">
                        <input className="py-2 pl-8 mr-2 w-2/3 border rounded border-gray-400 text-sm text-gray-700" placeholder="Dato" />
                        ...
                        <input className="py-2 pl-8 w-1/3 border rounded border-gray-400 text-sm text-gray-700" placeholder="Tid" />
