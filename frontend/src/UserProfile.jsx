					...
					<div className="px-5 py-5">
						<div className="border-b border-gray-300">
							<div className="flex items-center pb-4">
								...
								<div className="ml-5">
									<h1 className="font-bold text-2xl text-gray-800">God morgen, {this.state.user.name}</h1>
									<div className="flex items-center">
										<svg fill="currentColor" viewBox="0 0 20 20" className="text-green-400 h-5 w-5">
										...
										<span className="ml-1 mb-px font-medium text-gray-700 text-sm">Verifisert konto</span>
									</div>
								</div>
							</div>
						</div>
						<div class="pt-4">
							<button onClick={this.newTicketButtonHandler} className="bg-vy-green-700 text-white text-sm font-medium rounded-lg px-4 py-3 w-full hover:bg-vy-green-900">
								Ny billett
							</button>
						</div>
					</div>
						...
						<div className="flex items-center justify-between mb-5">
							...
							<Link to={'/tickets'}>
								<div className="text-sm text-gray-900 flex items-center">
										Se alle
										<svg fill="currentColor" viewBox="0 0 20 20" className="h-5 w-5 text-gray-600">
					...
					<div className="mt-12">
						...
						<div>
							<div className="bg-white shadow rounded-md">
								...
								<div className="border-b border-gray-300 px-5 py-5">
									<span className="text-gray-600 font-medium text-sm">Bensin</span>
									<p className="text-gray-900 text-xl">48,34 l</p>
								</div>
								<div className="border-b border-gray-300 px-5 py-5">
									<span className="text-gray-600 font-medium text-sm">Timer</span>
									<p className="text-gray-900 text-xl">17 t</p>
								</div>
								<div className="border-b border-gray-300 px-5 py-5">
									<span className="text-gray-600 font-medium text-sm">Antall kilometer reist</span>
